# annotation-cache/downloadsnpeffcache: Output
...
- [SnpEff](#snpeff) - Download SnpEff cache for the specified genome
...
The output folder will contain the SnpEff cache files for the specified genome.
